        ...
        {fileUrl && (
          <div className={Style.voterInfo}>
            ...
            <div className={Style.voterInfo_paragraph}>
              ...
              <p>
                Aff:&nbsp;<span>{candidateForm.age}</span>
              </p>
            </div>
          </div>
        )}
        ...
        {!fileUrl && (
          <div className={Style.sideInfo}>
            <div className={Style.sideInfo_box}>
              ...
              <p>
              This Decentralized voting website uses blockchain for secure, tamper-proof voting, ensuring integrity and transparency in the electoral process.
      ...
      <div className={Style.voter}>
        ...
        <div className={Style.input__container}>
          ...
          <Input
            inputType="text"
            title="Affiliation"
            placeholder="Candidate Affiliation"
            handleClick={(e) =>
